...
stocks = ['BABA', 'CVS', 'VOW3.DE', '2318.HK', 'BAYN.DE', 'WBD',
...
def main(stocks):
    print(
        f"{'Stock':<6} {'Est.Growth':>13} {'Intrinsic Value':>18} {'Price':>10} {'Discount':>16} {'Recommendation':>17}")
    print('--------------------------------------------------------------------------------------')
    ...
    if 'seaborn' in plt.style.available:
        ...
        print("Styl 'seaborn' není dostupný. Používá se výchozí styl.")
